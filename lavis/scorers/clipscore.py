...
class CLIPCapDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        c_data = clip.tokenize(self.prefix + c_data['caption'], truncate=True).squeeze()
...
def clipscore(candidates, image_dir, device=None, download_root=None):
    image_paths = [os.path.join(image_dir, item['image']) for item in candidates]
    ...
    model, transform = clip.load("ViT-B/32", device=device, jit=False, download_root=download_root)
    model.eval()
