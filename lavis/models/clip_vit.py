...
def create_clip_vit_L(img_size=224, use_checkpoint=False, precision="fp16", cached_file=None, num_top_layers_to_be_ignored=1):
    model = VisionTransformer(
            input_resolution=img_size,
            patch_size=14,
            width=1024,
            layers=24 - num_top_layers_to_be_ignored,
            heads=16,
