...
class BaseModel(nn.Module):
    ...
    def load_checkpoint(self, url_or_filename):
        ...
        # Modified by Yang B.
        logging.info("Missing {} keys, first of 5: {}".format(len(msg.missing_keys), msg.missing_keys[:5]))
        logging.info("Unexcepted keys: {}".format(msg.unexpected_keys))
    ...
    def load_checkpoint_from_config(self, cfg, **kwargs):
        ...
        if load_pretrained:
            ...
            ), "Found load_pretrained is True, but pretrain_path is None."
